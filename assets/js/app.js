...
export const updateWeather = function (lat, lon){
    ...
    console.log(url.currentWeather(lat,lon))
    console.log({lat,lon})
        const {
            weather,
            dt: dateUnix,
        ...
        fetchData(url.airPollution(lat,lon), function(airPollution) {
            ...
            <div class="highlight-list">
              <div class="card card-sm highlight-card one">
                <h3 class="title-3">Ari Quality Index</h3>
                <div class="wrapper">
                ...
                <div class="card-list">
                  <div class="card-item">
                    ...
                    <div>
                      ...
                      <p class="title-1">${module.getTimes(sunriseUnixUTC,timezone)}</p>
                    </div>
                  </div>
                  <div class="card-item">
                    ...
                    <div>
                      ...
                      <p class="title-1">${module.getTimes(sunsetUnixUTC,timezone)}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        fetchData(url.forecast(lat, lon), function(forecast){
          ...
          for(const [index, data] of forecastList.entries()){
            ...
            tempLi.innerHTML = `
              <div class="card card-sm slider-card">
                <p class="body-3">${module.getTimes(dateTimeUnix, timezone)}</p>
                <img
                  src="./assets/images/weather_icons/${icon}.png"
                  alt="${description}"
                  width="48"
          ...
          for(let i = 7, len =  forecastList.length ; i< len; i+=8){
            ...
            <p class="label-1">${module.days[date.getUTCDay()]}</p>
            `;
